...
public class StoryPresenter {
    ...
    public void loadMoreItems(User user) {
        if (!isLoading) {
            ...
            userService.getStory(Cache.getInstance().getCurrUserAuthToken(), user, PAGE_SIZE, lastStatus, new GetStoryObserver());
        }
    }
    ...
    public class GetStoryObserver implements UserService.GetStoryObserver {
